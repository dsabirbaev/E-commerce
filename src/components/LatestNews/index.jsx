...
const index = () => {
    return (
        <section className="py-[100px] bg-[#F3F4F6B3] dark:bg-gray-900 rounded-[40px] mt-5">
            <div className="container">
                <div className=" flex flex-col">
                    <h2 className="text-[32px] text-[#111827] dark:text-white font-semibold mb-[57px]">The latest news. <span className="text-[#6B7280]">From the Ciseco blog</span></h2>
                    <div className="flex justify-between mb-5">
                        <div className="flex flex-col">
                            ...
                            <h4 className="cursor-pointer hover:text-blue-500 dark:hover:text-gray-500 text-[24px] dark:text-white font-medium w-[544px] mb-[15px]">in arcu cursus euismod quis viverra nibh cras pulvinar mattis</h4>
                            <p className="text-[#6B7280] dark:text-white text-[16px] max-w-[544px] font-light mb-[25px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati vero perspiciatis ullam ea? Nihil accusamus similique debitis tempore mollitia? Aperiam.</p>
                        ...
                        <div className="flex flex-col justify-between">
                            <div className="flex">
                                <div className="w-[369px] flex flex-col justify-evenly">
                                    <h4 className="cursor-pointer hover:text-blue-500 dark:hover:text-gray-500 dark:text-white text-[16px]">Et leo duis ut diam quam nulla porttitor massa id</h4>
                                    <p className="text-[16px] text-[#6B7280] dark:text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt dolorem</p>
                    ...
                    <button className=" text-[14px] font-medium bg-white dark:bg-transparent dark:hover:text-white hover:bg-transparent hover:border-sky-300 dark:hover:border-white rounded-full px-5 py-3 border mx-auto">Show all blog articles</button>
                </div>
            </div>
        </section>
    );
