    ...
    return (
        <section className="pt-[100px]">
            <div className="container">
                <div>
                    <h2 className="text-[36px] font-semibold text-[#111827] dark:text-white">Shop by department</h2>
                    ...
                    >
                        ...
                        <SwiperSlide>
                            <div className="w-[276px] dark:border dark:border-gray-500 rounded-[20px]">
                                ...
                                <div className="text-center p-5">
                                    <h2 className="text-[18px] font-semibold mb-1 dark:text-white">Travel Kits</h2>
                                    <p className="text-[14px] text-[#6B7280] dark:text-white">20+ categories</p>
                                </div>
                            </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                            <div className="w-[276px] dark:border dark:border-gray-500 rounded-[20px]">
                                ...
                                <div className="text-center p-5">
                                    <h2 className="text-[18px] font-semibold mb-1 dark:text-white">Umbrella</h2>
                                    <p className="text-[14px] text-[#6B7280] dark:text-white">11+ categories</p>
                                </div>
                            </div>
                        </SwiperSlide>
