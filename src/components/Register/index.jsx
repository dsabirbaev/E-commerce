    ...
    return (
        <section className="pt-[100px]">
              <div className="container">
                <div className="register-email relative h-[578px] w-full  bg-[#F8FAFC] dark:bg-gray-500  rounded-[40px]">
                    ...
                    <div className="flex flex-col z-30 pt-[95px] pl-[96px] ">
                        <h2 className="text-[48px] text-[#0F172A] dark:text-white font-semibold leading-[48px] max-w-[419px] mb-5">
                            Don't miss out on special offers
                        </h2>
                        <p className="text-[#6B7280] dark:text-white leading-[24px] text-[16px] max-w-[467px] mb-[40px]">
                        ...
                        <ul className="max-w-[512px] flex flex-col gap-y-5 mb-[40px]">
                            <div className="flex items-center justify-start gap-[16px] dark:text-white">
                        ...
                        <div className="flex items-center justify-between z-30 bg-[#fff] rounded-full border-[1px] border-solid border-[#E5E7EB] w-[384px] h-[44px]  pr-[4px] pl-[16px]">
                            <input
                                type="email"
                                className=" outline-none border-none w-[300px] dark:placeholder:text-gray-500"
