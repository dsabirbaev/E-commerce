...
const index = () => {
  ...
  return (
    <section className="bg-gray-50 relative">
      <ToastContainer />
      <Link  to="/" className="absolute top-5 left-5"><button type="button" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Back</button></Link>
