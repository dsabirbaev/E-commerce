...
const index = () => {
    return (
        <footer className="pt-[120px] pb-[80px] border-t-2 dark:bg-gray-800">
            <div className="container">
                <div className="flex justify-between">
                    <div className="flex flex-col gap-y-4">
                        ...
                        <ul className="flex flex-col gap-y-3 text-[14px] dark:text-white">
                    ...
                    <ul className="text-[14px] flex flex-col gap-y-4 w-[120px] dark:text-white">
